...
export default defineEventHandler(async (event) => {
    try {
        const { user_id, selected_employee_ids, date_range } = await readBody(event);
        ...
        try {
            ...
            const employee_schedules_schedules = fetched_employee_schedules.reduce((accumulator, currentEmployeeSchedule) => {
                accumulator.push({
                    // id: currentEmployeeSchedule.id,
                    // employeesID: currentEmployeeSchedule.employeesID,
                    // scheduleID: currentEmployeeSchedule.scheduleID,
                    ...
                    schedules: fetched_schedules.reduce((accumulator, currentSchedule) => {
                        if(currentSchedule.id === currentEmployeeSchedule.scheduleID) {
                            ...
                            //     shortName: currentSchedule.shortName,
                            //     scheduleLegend: currentSchedule.scheduleLegend,
                            //     scheduleClass: currentSchedule.scheduleClass,
                            //     firstIn: currentSchedule.firstIn,
                            //     firstOut: currentSchedule.firstOut,
                            //     secondIn: currentSchedule.secondIn,
                            //     secondOut: currentSchedule.secondOut
                            // };
